...
class KMaxPooling(Layer):
    ...
    def __init__(self, k=1, axis=1, **kwargs):
        ...
        # to perform transpose for top k elements since top_k works in last axis
    ...
    def call(self, x):
        ...
        a = scipy.stats.norm(0, 1).pdf(0)
        top_k = tf.nn.top_k(transposed_for_topk, k=self.k*a, sorted=True, name=None)[0]
